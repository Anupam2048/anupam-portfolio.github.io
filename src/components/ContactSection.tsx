      ...
      <div className="mx-auto max-w-7xl px-5 sm:px-8">
        ...
        <div className="max-w-3xl">
          <h2 className="text-4xl font-medium tracking-tight text-white sm:text-6xl leading-[1.05]">
            ...
            <span className="text-lime-300">Let's connect.</span>
          </h2>
          <p className="mt-4 text-base leading-relaxed text-zinc-400">
            Open to full-time Data Analyst, MIS Executive, and Business Reporting roles.
            Reach out directly through email, direct phone call, WhatsApp, or LinkedIn.
          </p>
        </div>

        {/* Contact Channels Grid (No form, direct contact only) */}
            ...
            <div>
              ...
              <div className="mt-6">
                ...
                <p className="mt-2 text-xs leading-relaxed text-zinc-400">
                  Direct inbox for interviews, role opportunities, and data projects.
                </p>
              </div>
            </div>
          ...
          <div className="flex flex-col justify-between rounded-3xl border border-white/[.08] bg-white/[.02] p-6 sm:p-7 transition-all duration-300 hover:border-lime-400/40 hover:bg-white/[.035]">
            <div>
              ...
              <div className="mt-6">
                ...
                <p className="mt-2 text-xs leading-relaxed text-zinc-400">
                  Available for phone screening, recruiter calls, and instant WhatsApp chat.
                </p>
              </div>
            </div>
            ...
            <div className="mt-6 grid grid-cols-2 gap-2">
              ...
              <a
                href={`https://wa.me/${phoneNumber.replace("+", "")}?text=${encodeURIComponent(
                  "Hi Anupam, I reviewed your portfolio and would like to connect."
                )}`}
                target="_blank"
                rel="noreferrer"
              ...
              <div className="mt-6 space-y-3">
                <div>
                  ...
                  <p className="mt-1 text-xs text-zinc-400">
                    On-site, Hybrid, and Remote roles across India.
                  </p>
                </div>
